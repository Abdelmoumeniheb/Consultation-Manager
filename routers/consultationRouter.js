...
const {ReqConsultationByPatient,ConfirmedConsultationbyDoctor,RefusedConsultationbyDoctor,ProposeConsultationByDoctor,ConfirmeConsultationByPatient,getAllConsultation,getConsultationById,updateConsultation,deleteConsultation}=require('../controllers/consultationController');
